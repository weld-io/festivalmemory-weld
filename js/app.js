  ...
  $scope.register = function() {
    if ($scope.checkboxModel.value) {
      ...
      .success(function (data, status, headers, config) {
          ...
          $scope.websiteSnapshotUrl = snapshotUrl + data.projectId + '?user=' + data.userId + '&imageFormat=jpg&imageWidth=800&imageHeight=800&browserWidth=800&browserHeight=800';
